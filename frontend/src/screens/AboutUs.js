...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="absolute inset-0 bg-black opacity-20"></div>
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          <div className="mb-8">
            <span className="text-2xl md:text-3xl font-medium animate-typewriter">Hello World! Welcome to About Us Page</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">About LibraryApp</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        {/* Features Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">Why Choose LibraryApp?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Smart Book Management</h3>
              <p className="text-gray-600">Advanced catalog system with real-time inventory tracking and automated notifications</p>
            </div>
            <div className="text-center group">
              ...
              <p className="text-gray-600">Intuitive interface designed for both students and librarians with minimal learning curve</p>
            </div>
            <div className="text-center group">
              ...
              <p className="text-gray-600">Comprehensive reporting and insights to optimize library operations and user engagement</p>
            </div>
          </div>
        </div>

        {/* Developer Section */}
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-12 text-white mb-20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold mb-4">Shivansu Bisht</h3>
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a 
                  ...
                  className="bg-white text-gray-800 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center space-x-2"
                >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600">support@libraryapp.com</p>
            </div>
            <div className="flex flex-col items-center">
